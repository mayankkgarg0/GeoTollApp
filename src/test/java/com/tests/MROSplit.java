...
public class MROSplit extends BaseTest {

	@SuppressWarnings("deprecation")
	@Test(dataProvider = "loginData", dataProviderClass = TesData.class, priority = 1)
	public void LoginBV(String username, String password) throws InterruptedException, IOException {
...
//---------------------VIN Add Done(2ststep)--------------------------------------------------------------------------------------------------------------------------------------------------------//

	
//-------------------------------------------------Login Again--------------------------------------------------------------------------------------------------------------------------------------//

	@SuppressWarnings("deprecation")
	@Test(dataProvider = "loginData", dataProviderClass = TesData.class, priority = 2)
	public void LoginO(String username, String password) throws InterruptedException, IOException {
