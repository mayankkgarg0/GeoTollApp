...
public class NegDisWifiTermsnCondition extends BaseTest {

	@Test(dataProvider = "MROData", dataProviderClass = TesData.class, priority = 2)
	public void NegDisWifiTermsnConditionHamburger(String username, String password) throws InterruptedException {
...
//-----------------------------------------------------------------------------Report Technical Issue----------------------------------------------------------------------------------------------//	
			...
			try { // driver.findElement(AppiumBy
				...
				test.info("Reporting Technical Issue failed as Wifi id Disabled");
				test.pass(e);
