...
public  class  HamburgerFunc extends BaseTest{
	...
	public void ReportTecniicalIssue() throws InterruptedException {
	   ...
	   driver.findElement(AppiumBy.xpath("//android.widget.EditText[@resource-id=\"com.geotoll.egpsflex_android.dev:id/edt_email\"]")).click();
		 ...
		 driver.findElement(AppiumBy.xpath("//android.widget.Button[@resource-id=\"com.geotoll.egpsflex_android.dev:id/img_hamburger\"]")).click();
		 Thread.sleep(1000);
		 // Report techical issue -
		 test.info("Step 2: Click on RTissue page");
		 WebElement ReportTechnicalIssue = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.geotoll.egpsflex_android.dev:id/txt_label_report_issue")));
		 ReportTechnicalIssue.click();
		 waitForTime(1000);
		 // Short Desp -
		 test.info("Step 3: Create Short Description");
		 WebElement ShortDesc = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.geotoll.egpsflex_android.dev:id/edt_short_description")));
		 ShortDesc.click();
		 ShortDesc.sendKeys("ABCDE");
		// Details 
		 WebElement Details = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.geotoll.egpsflex_android.dev:id/edt_details")));
		 Details.click();
		 Details.sendKeys("Hi " + " Complete Details Enclosed");
		  
		 //Submit - 
		 test.info("Step 4: Click on Submit");
		 WebElement Submit = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.geotoll.egpsflex_android.dev:id/btn_submit")));
		 Submit.click();
		 waitForTime(8000);
		 WebElement SubmitttedTicketNo = wait.until(ExpectedConditions.elementToBeClickable(By.id("android:id/message")));
		...
		// WebElement AfterSubmitPopup = wait.until(ExpectedConditions.elementToBeClickable(By.id("//android:id/button1")));
		 //WebElement AfterSubmitPopup = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//android.widget.Button[@text=\"OK\"]")));
	...
	public void PrivacyPolicynTermsAndConditions() throws InterruptedException {
	   ...
	   driver.findElement(AppiumBy.xpath("//android.widget.EditText[@resource-id=\"com.geotoll.egpsflex_android.dev:id/edt_email\"]")).click();
		...
		// Privacy Policy
		 ...
		 WebElement PrivacyPolicy = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.geotoll.egpsflex_android.dev:id/txt_label_pp")));
		 PrivacyPolicy.click();
		 waitForTime(5000);
		...
		//After privacy back button takes back click hamburger icon
		 ...
		 WebElement TermsnCondition = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.geotoll.egpsflex_android.dev:id/txt_label_tc")));
		 TermsnCondition.click();
    	 waitForTime(5000);
    	
    	 test.info("Step 6: Back");
    	 WebElement BackButton1 = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.geotoll.egpsflex_android.dev:id/img_back")));
		BackButton1.click();
		 waitForTime(2000);
   ...
   driver.findElement(AppiumBy.xpath("//android.widget.EditText[@resource-id=\"com.geotoll.egpsflex_android.dev:id/edt_email\"]")).click();
	 ...
	 WebElement OldPassword = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.geotoll.egpsflex_android.dev:id/edt_old_password")));
	 OldPassword.click();
	 OldPassword.sendKeys("New@12345");
	 test.info("Step 4: Enter New Passwod");
	 WebElement NewPassword = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.geotoll.egpsflex_android.dev:id/edt_new_password")));
	 NewPassword.click();
	...
	// scroll("DOWN", 0.5); Scroll with not work as no place to swipe
	 ...
	 driver.navigate().back();
	 WebElement ReNewPassword = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.geotoll.egpsflex_android.dev:id/edt_confirm_new_password")));	
	 ReNewPassword.click();
	 ReNewPassword.sendKeys("New@12346");
	 driver.navigate().back();
	 WebElement UpdatePassword = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.geotoll.egpsflex_android.dev:id/btn_update_password")));
